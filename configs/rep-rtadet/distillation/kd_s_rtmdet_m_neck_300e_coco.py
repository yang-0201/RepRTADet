...
teacher_ckpt = 'work_dirs/rtmdet_m/1.16.0.7515.pth'  # noqa: E501
...
model = dict(
    ...
    teacher=dict(
        cfg_path='mmyolo::rtmdet/rtmdet_m.py'),
...
custom_hooks = [
    ...
    dict(type='mmrazor.StopDistillHook', stop_epoch=80)
]
load_from = 'kd_s_rtmdet_m_neck_300e_coco_20230220_140647-446ff003.pth'
